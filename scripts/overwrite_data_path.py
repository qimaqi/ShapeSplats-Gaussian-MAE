...
ShapeNet55GS_dir = os.path.join(
    WORKING_DIR, "cfgs", "dataset_configs", "ShapeNet55GS.yaml"
)
...
ModelNet40_dir = os.path.join(
    WORKING_DIR, "cfgs", "dataset_configs", "ModelNet40GS.yaml"
)
...
ModelNet10_dir = os.path.join(
    WORKING_DIR, "cfgs", "dataset_configs", "ModelNet10GS.yaml"
)
